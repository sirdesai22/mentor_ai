...
const ChatComponent = () => {
  ...
  return (
    <div className="flex flex-col items-center">
      <button
        className="chatui-btn bg-emerald-500 text-white rounded-md p-2"
        onClick={() => {
      ...
      <div className="chatui">
        ...
        <div className="chatui-inputarea">
          <input
            id="chatui-input"
            type="text"
            className="chatui-input bg-gray-800 text-white rounded-md p-2"
          ...
          />
          <button
            className="chatui-btn bg-blue-500 text-white rounded-md p-2"
            onClick={() => {
              chat_ui
                .onGenerate(prompt, updateMessage, setRuntimeStats)
                .catch((error) => console.log(error));
      ...
      <div className="chatui-extra-control">
        <button
          className="chatui-btn bg-red-500 text-white rounded-md p-2"
          onClick={() => {
            chat_ui
              .onReset(() => {
                setMessages([]);
